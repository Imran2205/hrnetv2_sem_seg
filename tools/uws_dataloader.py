    ...
    def __init__(self, 
        ...
        if not self.channel_values:
            ...
            self.label_dictionary = {
                ...
                29: {'name': 'others',      'train_id': 28,  'color': (178, 178, 178)}, ## begining of UWSv2 new semantic categories
                30: {'name': 'beaver',      'train_id': 29,  'color': (151, 191, 201)},
                31: {'name': 'duck',        'train_id': 30,  'color': (153, 102, 51)},
                32: {'name': 'dugong',      'train_id': 31,  'color': (229, 0, 229)},
                33: {'name': 'hippo',       'train_id': 32,  'color': (255, 255, 178)},
                34: {'name': 'lobster',     'train_id': 33,  'color': (222, 128, 4)},
                35: {'name': 'platypus',    'train_id': 34,  'color': (102, 87, 110)},
                36: {'name': 'nautilus',    'train_id': 35,  'color': (229, 229, 0)},
                37: {'name': 'sea_cucumber','train_id': 36,  'color': (229, 255, 255)},
                38: {'name': 'sea_lion',    'train_id': 37,  'color': (173, 173, 0)},
                39: {'name': 'sea_snake',   'train_id': 38,  'color': (0, 0, 102)},
                40: {'name': 'barracouta',  'train_id': 39,  'color': (77, 0, 0)},
                41: {'name': 'billfish',    'train_id': 40,  'color': (170, 184, 90)},
                42: {'name': 'coho',        'train_id': 41,  'color': (174, 230, 187)},
                43: {'name': 'eel',         'train_id': 42,  'color': (0, 178, 178)},
                44: {'name': 'goldfish',    'train_id': 43,  'color': (173, 121, 0)},
                45: {'name': 'jellyfish',   'train_id': 44,  'color': (97, 194, 157)},
                46: {'name': 'lionfish',    'train_id': 45,  'color': (0, 128, 255)},
                47: {'name': 'puffer',      'train_id': 46,  'color': (87, 106, 110)},
                48: {'name': 'rock_beauty', 'train_id': 47,  'color': (142, 173, 0)},
                49: {'name': 'sturgeon',    'train_id': 48,  'color': (27, 71, 74)},
                50: {'name': 'tench',       'train_id': 49,  'color': (209, 88, 88)}                
            }
        else:
